export interface ReceiptDetails {
  day: string; // From original App.tsx state
  month: string; // From original App.tsx state
  year: string; // From original App.tsx state
  receiptDate: string; // For <input type="date">, usually YYYY-MM-DD
